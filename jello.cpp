...
void myinit()
{
  ...
  glClearColor(0.76, 0.89, 0.93, 0.0);
...
void reshape(int w, int h) 
{
  ...
  gluPerspective(70.0f, aspectRatio, 0.01f, 1000.0f);
...
void display()
{
  ...
  */
  ...
  // green
  //GLfloat mKa[] = { 0.2, 0.6, 0.2, 0.5};
  //GLfloat mKd[] = { 0.2, 0.6, 0.2, 0.5};
  //GLfloat mKs[] = { 0.2, 0.6, 0.2, 0.5};
  //GLfloat mKe[] = { 0.2, 0.6, 0.2, 1.0};
  GLfloat mKa[] = { 0.2, 0.6, 0.0, 0.5 };
  GLfloat mKd[] = { 0.2, 0.6, 0.0, 0.5 };
  GLfloat mKs[] = { 0.2, 0.6, 0.0, 0.5 };
  ...
  glBlendFunc(GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA); // blending property
  // show the cube
  showCube(&jello);
...
void doIdle()
{
  ...
  std::cout << "fps: " << 1 / elapsedTime << std::endl;
  ...
  if (saveScreenToFile==1)
  {
    ...
    if (sprite < 300) saveScreenToFile = 1; // save only once, change this if you want continuos image generation (i.e. animation)
    else sprite = 0;
    sprite++;
  }
